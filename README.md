...
Follow these [instructions](https://github.com/parodos-dev/orchestrator-helm-operator/blob/gh-pages/kafka-knative-broker/README.md) to setup the a kafka broker.
