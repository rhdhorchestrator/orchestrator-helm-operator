...
ARG IMG=quay.io/redhat-user-workloads/orchestrator-releng-tenant/helm-operator/operator-controller@sha256:41dd2d2aea08097f5470f6077306f94059e4b2b859a665bb2980d5b6148b6e0a
WORKDIR /operator
COPY . .
