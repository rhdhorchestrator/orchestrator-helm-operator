...
ARG IMG=quay.io/redhat-user-workloads/orchestrator-releng-tenant/helm-operator/operator-controller@sha256:a112ab0af41af6fb63f646c3561d52b97972b1434dab70ae2d7014e81e916427
WORKDIR /operator
COPY . .
