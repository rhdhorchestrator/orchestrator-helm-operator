...
ARG IMG=quay.io/redhat-user-workloads/orchestrator-releng-tenant/helm-operator/operator-controller@sha256:f1d88a3785e36d99801cbd07349f5ae8ffbf1439b9bc22fe8d449a0d85df93ed
WORKDIR /operator
COPY . .
