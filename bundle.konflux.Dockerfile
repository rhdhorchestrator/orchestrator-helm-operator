...
ARG IMG=quay.io/redhat-user-workloads/orchestrator-releng-tenant/helm-operator/controller-rhel9-operator@sha256:fa3a93c9f1f37dc05cb2ade6e6849810bbeabc6decbfc959d5015dacfca565a2
WORKDIR /operator
COPY . .
