...
ARG IMG=quay.io/redhat-user-workloads/orchestrator-releng-tenant/helm-operator/operator-controller@sha256:6fc66dafbfbfe65e271aea49eb125084679c127cfffc15a2962659d7e693e35c
WORKDIR /operator
COPY . .
