...
ARG IMG=quay.io/redhat-user-workloads/orchestrator-releng-tenant/helm-operator/operator-controller@sha256:06e01a1bd37bda9b8b0056d0742c938d88137400f9fe3a9fc9ce54175349df92
WORKDIR /operator
COPY . .
