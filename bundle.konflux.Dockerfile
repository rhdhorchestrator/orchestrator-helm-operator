...
ARG IMG=quay.io/redhat-user-workloads/orchestrator-releng-tenant/helm-operator/operator-controller@sha256:8c46a03a07b4cbb28684aa3c432c99f3eebd8a5ad4d00fbb3096e1ea25f6591c
WORKDIR /operator
COPY . .
