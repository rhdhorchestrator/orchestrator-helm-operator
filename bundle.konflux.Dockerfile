...
ARG IMG=quay.io/redhat-user-workloads/orchestrator-releng-tenant/helm-operator/operator-controller@sha256:12ff10c7fbbd25dde99a678c9f7656071974bd3ae7be707ee1feffea46457c63
WORKDIR /operator
COPY . .
