...
ARG IMG=quay.io/redhat-user-workloads/orchestrator-releng-tenant/helm-operator/controller-rhel9-operator@sha256:f930d524b7ca80ab4297196669ec74d53961f610e34dee2fff353b1aa29cbe85
WORKDIR /operator
COPY . .
