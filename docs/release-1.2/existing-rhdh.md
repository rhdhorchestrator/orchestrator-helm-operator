...
1. Verify resources and wait until they are running
   ...
   1. If any service does not become available, verify the logs for that service or consult [troubleshooting steps](https://www.prhdhorchestrator.io/main/docs/serverless-workflows/troubleshooting/).
